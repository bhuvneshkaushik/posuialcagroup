...
<!-- Bootstrap 3.3.7 -->
<link rel="stylesheet" href="{{URL::asset('asset/bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
<!-- Font Awesome -->
<link rel="stylesheet" href="{{URL::asset('asset/bower_components/font-awesome/css/font-awesome.min.css')}}">
<!-- Ionicons -->
<link rel="stylesheet" href="{{URL::asset('asset/bower_components/Ionicons/css/ionicons.min.css')}}">
<!-- Theme style -->
...
<!-- Daterange picker -->
<link rel="stylesheet" href="{{URL::asset('asset/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
